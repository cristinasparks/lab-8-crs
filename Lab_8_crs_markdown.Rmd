...
plot(density(all_ppp, signma = 0.4))
...
oil_qt # The data are not randomly spatially distributed
...
#Our observed data has a higher proportion of point pairs with nearest neighbors at shorter distances compared with CSR data
